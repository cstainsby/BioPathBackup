"""
Zach B - This file is used for checking if a socket is open
        Specifically used in /docker-compose.yaml to check if database socket is open before running server
        command to avoid backend/frontend race condition. 
