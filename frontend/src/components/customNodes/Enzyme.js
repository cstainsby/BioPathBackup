...
// TODO: This is so ugly, store this string in the backend as the enzyme's image
        ...
        for (let i = 0; i < data.substrates.length; i++) {
            handles.push(
                <Handle
                    ...
                    style={{
                        left: getHandleLocation(i, data.substrates.length, -15),
                        background: '#555',
                    }}
                    onConnect={(params) =>
        ...
        for (let i = 0; i < data.products.length; i++) {
            handles.push(
                <Handle
                    ...
                    style={{
                        left: getHandleLocation(i, data.products.length, -15),
                        background: '#555',
                    }}
                    onConnect={(params) =>
                        console.log('handle onConnect', params)
