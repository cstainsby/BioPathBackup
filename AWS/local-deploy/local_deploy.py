...
# simple python script to automate deployment while github actions isn't completely 
# set up
...
# login to AWS
# print("-----------------------------------------------------")
# print("     Logging Into AWS Using Credentials.txt")
# print("-----------------------------------------------------")
# os.system(f"""aws ecr get-login-password --region {REGION_NAME} \
#               | docker login \
#                 --username AWS \
