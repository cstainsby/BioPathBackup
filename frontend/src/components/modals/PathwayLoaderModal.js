...
function PathwayLoaderModal() {
                            ...
                            <Link to={"/pathway/" + pathway.id}>
                                ...
                                >
                                    <div className="container text-center">
                                        <h3 className="loadPathwayListTitle">
                                            {pathway.name}
                                        </h3>
                                        <p className="loadPathwayListAuthor">
    ...
    return (
        <div
            ...
            id="PathwayLoaderModal"
            tabIndex="-1"
            aria-labelledby="PathwayLoaderModalLabel"
            aria-hidden="true"
        >
                    ...
                    <div className="modal-body">
                        {pathways !== null ? (
                            pathways.length > 0 ? ( // if there are pathways to display
                                ...
                                <h4>Looks like there aren't any pathways</h4>
